            ...
            <div className="flex flex-col items-center md:flex-row gap-y-6 gap-x-12 lg:gap-x-24 xl:gap-x-36 relative">
              ...
              <div className="flex flex-col ">
                ...
                >
                  ...
                  memberikan landasan kuat untuk sukses dalam karier dan
            ...
            <div className="flex flex-col items-center md:justify-start md:mr-auto md:flex-row-reverse gap-y-6 gap-x-12 lg:gap-x-24 xl:gap-x-36">
              <figure className="rounded-lg">
                <Image
                  width={507}
                  height={335}
                  src={"/assets/images/TentangKami/tentangkami-perjalanan.jpg"}
                ...
                <div className=" flex justify-between text-left">
                  ...
                  >
                    ...
                    >
                      ...
                      Daftar. Setelah mendaftar, Anda akan mendapatkan akses ke
                      konten pembelajaran dan alat pembelajaran seperti video,
                      materi, dan tes. Semua layanan Gratis tanpa dipungut
                      biaya!
                    </p>
                  </div>
                  {activeFaq === 2 ? (
              ...
              >
                <div className=" flex justify-between text-left">
                  ...
                  >
                    ...
                    >
                      Layanan EduSri menawarkan fleksibilitas belajar, akses ke
                      berbagai topik, dan kesempatan untuk mendapatkan
