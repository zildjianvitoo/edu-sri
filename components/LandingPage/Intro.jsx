...
import bgUrl from "@/public/assets/images/LandingPage/landingpage-intro.svg";

export default function Intro() {
  return (
    <section className="bg-gradient-to-b from-[#9e94d0] to-[#887ec5] py-14  relative">
      <div className="container ">
        <div className="absolute w-9 h-9 rounded-full right-[16rem] top-[3rem] bg-greenEduSri hidden lg:block" />
        <div className="flex flex-col gap-3 mt-3 text-center">
          ...
          <h4 className="text-lg font-medium text-white lg:text-xl ">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Rem,
            obcaecati?
          </h4>
          <hr className="w-1/4 mx-auto mt-3 " />
          <div className="flex flex-wrap justify-center gap-10 mt-6">
            <div className="absolute w-6 h-6 rounded-full left-[30rem] top-[11rem] bg-orangeEduSri hidden lg:block" />
            <div
